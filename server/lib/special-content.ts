...
export const DEFAULT_SPECIAL: SpecialData = {
  ...
  thanks: [
    { id: 'emily', name: 'emily', role: t('developer', 'разработчик'), avatar: 'emily.webp', url: 'https://github.com/emilumiq', text: t('helped with bugs on the site, rewrote the frontend to solidjs', 'помогала с багами на сайте, переписала фронт на solidjs') },
    { id: 'ilja', name: 'ilja', role: t('anykey, gamer', 'аньки, геймер'), avatar: 'ilja.webp', url: 'https://t.me/sobiratelPeca', text: t('provided financial support for the whole infrastructure', 'помогал всей инфраструктуре финансово') },
    { id: 'toffo', name: 'toffo', role: t('musician, designer', 'музыкант, дизайнер'), avatar: 'toffo.webp', url: 'https://cultoffoil.bandcamp.com/', text: t('helped fix english translation errors', 'помогала с ошибками перевода на английский') },
    { id: 'okroshka7', name: 'okroshka7', role: t('anykey, technologies enjoyer', 'аньки, любитель технологий'), avatar: 'okroshka7.webp', url: 'https://t.me/okroshka7p', text: t('helped fix english translation errors', 'помогала с ошибками перевода на английский') },
    { id: 'matbeq', name: 'matbeq', role: t('anykey, d7tun6 music enjoyer', 'аньки, любитель музыки d7tun6'), avatar: 'matbeq.webp', url: 'https://t.me/matbeq332', text: t('helped hunt bugs, provided analog release formats as extras for the site, supported the vpn infrastructure', 'помогал с поиском багов, поставлял аналоговые версии релизов как дополнение на сайт, поддерживал инфраструктуру (оплата vpn)') },
