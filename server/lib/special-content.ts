...
export const DEFAULT_SPECIAL: SpecialData = {
  ...
  thanks: [
    ...
    { id: 'toffo', name: 'toffo', role: t('musician, designer', 'музыкант, дизайнер'), avatar: 'toffo.webp', url: 'https://cultoffoil.bandcamp.com/', text: t('helped fix english translation errors', 'помогал с ошибками перевода на английский') },
